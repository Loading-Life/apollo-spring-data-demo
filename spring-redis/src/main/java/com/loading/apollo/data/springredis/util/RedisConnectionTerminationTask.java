...
public class RedisConnectionTerminationTask implements Runnable {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(RedisConnectionTerminationTask.class);
    private static final int RETRY_DELAY_IN_MILLISECONDS = 5000;

    private final RedisConnectionFactory redisConnectionFactory;
    private final ScheduledExecutorService scheduledExecutorService;

    public RedisConnectionTerminationTask(RedisConnectionFactory redisConnectionFactory, ScheduledExecutorService scheduledExecutorService) {
    ...
    private boolean terminate(RedisConnectionFactory redisConnectionFactory) {
        try {
            ...
            if (redisConnectionFactory instanceof LettuceConnectionFactory) {
                return terminateRedisConnectionFactory((LettuceConnectionFactory) redisConnectionFactory);
            }
    ...
    private boolean terminateRedisConnectionFactory(LettuceConnectionFactory redisConnectionFactory) {
